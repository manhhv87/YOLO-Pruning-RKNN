...
\begin{titlepage}
  ...
  \vspace{1.5 cm}
  \HRule \\[0.4cm]
  { \huge \bfseries Know-When-to-Trust Crop-Row Guidance: Conformal Heading Intervals and a Risk-Controlled Steering Policy on a Stock Edge Detector} % Title of your document
  \HRule \\[1.5cm]
